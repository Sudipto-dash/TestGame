...
public class PlayerData : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField]
    TMPro.TextMeshProUGUI CoinUI;
    
    [SerializeField]
    TMPro.TextMeshProUGUI StoneUI;
    
    [SerializeField]
    TMPro.TextMeshProUGUI WoodUI;
    ...
    void FixedUpdate()
    {
        ...
        StartCoroutine(playerOwnWorldData.FetchPlayerData(result => {
            ...
            CoinUI.text=coinCnt.ToString();
            WoodUI.text = woodCnt.ToString();
            StoneUI.text = stoneCnt.ToString();
        }));
          /*
